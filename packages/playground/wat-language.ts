...
export interface WatLanguageDefinition {
  id: string;
  extensions: string[];
  aliases: string[];
...
export const watLanguage: WatLanguageDefinition = {
  id: 'wat',
  extensions: ['.wat', '.wast'],
  ...
  completionItems: [
    // Module structure
    {
      ...
      insertText: '(module\n  $0\n)',
      insertTextRules: 4,
      documentation: 'Define a WebAssembly module',
    },
    {
      label: 'func',
      kind: 'Keyword',
      insertText: '(func $$1 (param $2) (result $3)\n  $0)',
      insertTextRules: 4,
    ...
    },
    {
      ...
      insertText: '(result $1)',
      insertTextRules: 4,
      documentation: 'Function result type',
    },
    {
      label: 'local',
      kind: 'Keyword',
    ...
    },
    {
      ...
      insertText: '(memory $1)',
      insertTextRules: 4,
      documentation: 'Linear memory',
    },
    {
      label: 'table',
      kind: 'Keyword',
      insertText: '(table $1 funcref)',
      insertTextRules: 4,
      documentation: 'Function table',
    },
    {
      label: 'import',
      kind: 'Keyword',
      insertText: '(import "$1" "$2" ($3))',
      insertTextRules: 4,
      documentation: 'Import from host',
    },
    {
      label: 'export',
      kind: 'Keyword',
      insertText: '(export "$1" ($2))',
      insertTextRules: 4,
      documentation: 'Export to host',
    },
    {
      label: 'type',
      kind: 'Keyword',
      insertText: '(type $$1 (func (param $2) (result $3)))',
      insertTextRules: 4,
    ...
    // i32 operations
    {
      label: 'i32.const',
      kind: 'Function',
      insertText: '(i32.const $1)',
      insertTextRules: 4,
      documentation: 'i32 constant',
    },
    ...
    { label: 'i32.mul', kind: 'Function', documentation: 'i32 multiplication' },
    {
      label: 'i32.div_s',
      kind: 'Function',
      documentation: 'i32 signed division',
    },
    {
      label: 'i32.div_u',
      kind: 'Function',
      documentation: 'i32 unsigned division',
    },
    {
      label: 'i32.load',
      kind: 'Function',
      documentation: 'Load i32 from memory',
    },
    {
      label: 'i32.store',
      kind: 'Function',
      documentation: 'Store i32 to memory',
    },
    ...
    { label: 'i32.eqz', kind: 'Function', documentation: 'i32 equals zero' },
    {
      label: 'i32.lt_s',
      kind: 'Function',
      documentation: 'i32 signed less than',
    },
    {
      label: 'i32.gt_s',
      kind: 'Function',
      documentation: 'i32 signed greater than',
    },
    ...
    // Local/global
    {
      label: 'local.get',
      kind: 'Function',
      insertText: '(local.get $$1)',
      insertTextRules: 4,
      documentation: 'Get local variable',
    },
    {
      label: 'local.set',
      kind: 'Function',
      insertText: '(local.set $$1)',
      insertTextRules: 4,
      documentation: 'Set local variable',
    },
    {
      label: 'local.tee',
      kind: 'Function',
      insertText: '(local.tee $$1)',
      insertTextRules: 4,
      documentation: 'Tee local variable',
    },
    {
      label: 'global.get',
      kind: 'Function',
      insertText: '(global.get $$1)',
      insertTextRules: 4,
      documentation: 'Get global variable',
    },
    {
      label: 'global.set',
      kind: 'Function',
      insertText: '(global.set $$1)',
      insertTextRules: 4,
      documentation: 'Set global variable',
    },
    ...
    // Memory
    {
      label: 'memory.size',
      kind: 'Function',
      documentation: 'Get memory size in pages',
    },
    {
      label: 'memory.grow',
      kind: 'Function',
      documentation: 'Grow memory by pages',
    },
  ],
};
